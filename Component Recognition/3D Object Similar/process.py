...
from utility.ogl import *
from utility.ogl.objloader import tiny_obj
from utility.ogl import light
...
def run_ogl():
    ...
    if 1 == 1:
        obj = tiny_obj( "", fobj, swapyz=False)
        obj.create_bbox()
...
'''
The follow code is not necessary and is out of the show 3D obj task. I save this for your to learn and use one day.
'''
