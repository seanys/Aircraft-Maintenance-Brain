...
__C.DATASETS.SHAPENET.RENDERING_PATH        = '/Users/sean/Datasets/ShapeNet/ShapeNetRendering/%s/%s/rendering/%02d.png' #OK
# __C.DATASETS.SHAPENET.RENDERING_PATH      = '/home/hzxie/Datasets/ShapeNet/PascalShapeNetRendering/%s/%s/render_%04d.jpg'
__C.DATASETS.SHAPENET.VOXEL_PATH            = '/Users/sean/Datasets/ShapeNet/ShapeNetVox32/%s/%s/model.binvox' #OK
__C.DATASETS.PASCAL3D                       = edict()
__C.DATASETS.PASCAL3D.TAXONOMY_FILE_PATH    = './datasets/Pascal3D.json'
__C.DATASETS.PASCAL3D.ANNOTATION_PATH       = '/Users/sean/Datasets/PASCAL3D/Annotations/%s_imagenet/%s.mat'
__C.DATASETS.PASCAL3D.RENDERING_PATH        = '/Users/sean/Datasets/PASCAL3D/Images/%s_imagenet/%s.JPEG'
__C.DATASETS.PASCAL3D.VOXEL_PATH            = '/Users/sean/Datasets/PASCAL3D/CAD/%s/%02d.binvox'
__C.DATASETS.PIX3D                          = edict()
__C.DATASETS.PIX3D.TAXONOMY_FILE_PATH       = './datasets/Pix3D.json'
__C.DATASETS.PIX3D.ANNOTATION_PATH          = '/Users/sean/Datasets/Pix3D/pix3d.json' #OK
__C.DATASETS.PIX3D.RENDERING_PATH           = '/Users/sean/Datasets/Pix3D/img/%s/%s.%s' #OK
__C.DATASETS.PIX3D.VOXEL_PATH               = '/Users/sean/Datasets/Pix3D/model/%s/%s/%s.binvox' #OK
